  ...
  <div class="top-content">
    ...
    <div class="inner-bg">
      <div class="container">
        ...
        <div class="col-sm-6 col-sm-offset-3 form-box">
          <div class="form-top" style="background-color: #FFA500;">
          ...
          <div class="form-group form-popup form-bottom" id="myForm">
            <form action="stud_login.php" class="form-container" method="post">
              <div class="form-group">
                <label class="sr-only" for="form-username">Email</label>
                <input class="form-control" type="text" placeholder="Enter E-mail" name="email" required>
              </div>
              <div class="form-group">
                <label class="sr-only" for="form-password">Password</label>
                <input class="form-control" type="password" placeholder="Enter Password" name="stud_pass" required>
              </div>
